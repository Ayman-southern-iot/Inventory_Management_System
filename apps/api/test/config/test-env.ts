...
export const TEST_ENV: Record<string, string> = {
  ...
  LOGIN_THROTTLE_BASE_WINDOW_SECONDS: '5',
  LOGIN_THROTTLE_MAX_WINDOW_SECONDS: '300',
  ...
  IMPORT_FUZZY_MATCH_THRESHOLD: '0.45',
  IMPORT_CONFIRMATION_TTL_MINUTES: '60',
  IMPORT_HISTORY_LIMIT: '50',
  IMPORT_MAX_CHANGED_SHELVES: '10000',
